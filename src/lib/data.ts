...
export const mails: Mail[] = [
  ...
  },
  {
    id: 'e1f2g3h4i5',
    name: 'ReactMail Team',
    email: 'team@reactmail.com',
    avatar: 'https://picsum.photos/seed/reactmail/40/40',
    subject: 'Welcome to ReactMail!',
    text: "Hello and welcome to ReactMail!\n\nWe're thrilled to have you on board. ReactMail is designed to be a clean, fast, and delightful email experience.\n\nHere are a few tips to get you started:\n- Use `Cmd/Ctrl + K` to open the command menu.\n- Customize your theme in the settings.\n- Organize your inbox with labels.\n\nIf you have any questions, feel free to reply to this email. We're here to help!\n\nHappy mailing,\nThe ReactMail Team",
